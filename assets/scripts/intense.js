    ...
    function positionTarget() {
      ...
      if (horizontalOrientation === true) {
        ...
        if (mouse.xCurr !== lastPosition) {
          ...
          target.style["webkitTransform"] = "translate(" + position + "px, 50px)";
          target.style["MozTransform"] = "translate(" + position + "px, 50px)";
          target.style["msTransform"] = "translate(" + position + "px, 50px)";
        ...
        if (mouse.yCurr !== lastPosition) {
          ...
          target.style["webkitTransform"] = "translate( 50px, " + position + "px)";
          target.style["MozTransform"] = "translate( 50px, " + position + "px)";
          target.style["msTransform"] = "translate( 50px, " + position + "px)";
